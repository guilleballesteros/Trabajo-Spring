...
/**
 * ImplementaciÃ³n de un {@link StorageService} que almacena
 * los ficheros subidos dentro del servidor donde se ha desplegado
 * la apliacaciÃ³n.
 * 
 * ESTO SE REALIZA ASÃ� PARA NO HACER MÃ�S COMPLEJO EL EJEMPLO.
 * EN UNA APLICACIÃ“N EN PRODUCCIÃ“N POSIBLEMENTE SE UTILICE
 * UN ALMACÃ‰N REMOTO.
 * 
 * 
...
public class FileSystemStorageService implements StorageService{
	...
	// Directorio raiz de nuestro almacÃ©n de ficheros 
    ...
    /**
     * MÃ©todo que almacena un fichero en el almacenamiento secundario
    ...
    /**
     * MÃ©todo que devuelve la ruta de todos los ficheros que hay
    ...
    /**
     * Metodo que es capaz de cargar un fichero a partir de su nombre
    ...
    /**
     * MÃ©todo que es capaz de cargar un fichero a partir de su nombre
    ...
    /**
     * MÃ©todo que elimina todos los ficheros del almacenamiento
    ...
    /**
     * MÃ©todo que inicializa el almacenamiento secundario del proyecto
     */
    @Override
    public void init() {
        try {
